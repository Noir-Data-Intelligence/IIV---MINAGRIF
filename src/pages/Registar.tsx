          ...
          <div className="space-y-6">
            ...
            <div>
              <h1 className="font-serif text-4xl leading-[1.15]">
                Junte-se ao<br />Instituto de<br />Investigação<br />Veterinária
              </h1>
              <p className="mt-4 text-lg text-primary-foreground/70 max-w-sm leading-relaxed">
                Crie a sua conta para aceder ao sistema integrado de gestão laboratorial.
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-xl bg-primary-foreground/10 backdrop-blur-sm p-4 border border-primary-foreground/10 max-w-sm">
              ...
              <p className="text-sm text-primary-foreground/70">
                A sua conta será verificada por email antes da activação.
              </p>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2">
            <h2 className="font-serif text-2xl font-bold text-foreground">Criar Conta</h2>
            <p className="text-muted-foreground text-sm">Preencha os dados para solicitar acesso ao sistema.</p>
          </div>

          <form onSubmit={handleSignup} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm font-medium">Nome Completo</Label>
              <Input id="name" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="O seu nome completo" required className="h-11" />
            </div>
            <div className="space-y-2">
