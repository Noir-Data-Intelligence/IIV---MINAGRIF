...
function buildLoteSchema(t: TFunction) {
  return z.object({
    ...
    // Gerado automaticamente pelo servidor — nunca preenchido pelo utilizador.
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  ...
                  <FormControl>
                    {editItem ? (
                      <Input value={editItem.batchNumber} disabled />
                    ) : (
                      <Input value={t("form.placeholders.batchNumberAutoGenerated")} disabled />
                    )}
                  </FormControl>
                  <FormMessage />
                </FormItem>
