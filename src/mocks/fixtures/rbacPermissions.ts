...
export const rbacPermissionsFixtures: PermissionEntryDto[] = [
  // Recepcionista passa a poder ver Notícias (default não inclui).
  { role: "recepcionista", module: "noticias", canView: true, canWrite: false },
  // Técnico ganha acesso de escrita a Estações (default não inclui).
  { role: "tecnico", module: "estacoes", canView: true, canWrite: true },
  // Gestor de Estação passa a ver Logs de Actividade (default não inclui).
  { role: "gestor-estacao", module: "logs", canView: true, canWrite: false },
  // Director ganha escrita em Documentos (default é só leitura).
  { role: "diretor", module: "documentos", canView: true, canWrite: true },
  // Recepcionista passa a ver+escrever Mensagens (default não inclui).
  { role: "recepcionista", module: "mensagens", canView: true, canWrite: true },
];
